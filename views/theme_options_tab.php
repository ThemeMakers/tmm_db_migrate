...
<div class="option">
	...
	<div class="controls alternative admin-one-half">
		...
		<a href="#" class="button" id="button_prepare_import_data"><?php esc_html_e('Demo Data Install', 'tmm_db_migrate'); ?></a>
...
<div class="option">
	...
	<div class="controls alternative admin-one-half">
		...
		<a href="#" class="button" id="button_prepare_export_data"><?php esc_html_e('Export Data', 'tmm_db_migrate'); ?></a>
